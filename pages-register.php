...
if(isset($_POST['btnSubmit']))
{
    ...
    $query1="insert into admin( name, email, usename, password)values('$name','$email','$username','$password')";
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="index.html" class="logo d-flex align-items-center w-auto">
                  ...
                  <span class="d-none d-lg-block">Auto Timetable</span>
                </a>
              </div><!-- End Logo -->
              ...
              <div class="credits">
                ...
                Developed by <a href="https://portrafay.netlify.app/">ABDUL RAFAY SIDDIQUI.</a>
              </div>
